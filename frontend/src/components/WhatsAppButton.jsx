...
export default function WhatsAppButton() {
  ...
  if (settings?.socialWhatsapp && settings.socialWhatsapp.startsWith("http")) {
    whatsappUrl = settings.socialWhatsapp;
  }
  ...
  return (
    ...
    >
      ...
      <svg
        className="w-6 h-6 fill-current relative z-10 shrink-0"
        viewBox="0 0 24 24"
      >
      ...
      {/* Label Text */}
      <span className="font-extrabold text-xs tracking-wide hidden sm:inline-block relative z-10">
        WhatsApp Us
      </span>
    </a>
  );
